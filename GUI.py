...
def access():
    ...
    while True:
        ...
        if event == "yes":
            ...
            # Return ID and date
            if values['ID_Val'][0:1] == '%A': # If swipe card
              return int(values['ID_Val'][2:11]), datetime.now()
            
            else:
              return int(values['ID_Val']), datetime.now()
...
def admin():
    ...
    while True:
        ...
        if event == "yes":
            ...
            # Return ID
            if values['ID_Val'][0:1] == '%A': # If swipe card
              return int(values['ID_Val'][2:11])
            
            else:
              return int(values['ID_Val'])
